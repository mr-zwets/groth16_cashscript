...
//   verifier/src/bch/groth16-singleton-multiproof-vectors.json
//
//   node gen_multiproof.mjs            mint EXTRA_PROOFS (default 3) extra proofs
import { execFileSync } from 'node:child_process';
import { readFileSync, writeFileSync } from 'node:fs';
import { pathToFileURL } from 'node:url';

const VERIFIER = 'C:/Users/mathi/Desktop/verifier';
const LIBAUTH = pathToFileURL(`${VERIFIER}/node_modules/@bitauth/libauth/build/index.js`).href;
const NOBLE = pathToFileURL(`${VERIFIER}/node_modules/@noble/curves/bn254.js`).href;
const {
...
const vec = JSON.parse(readFileSync(`${VERIFIER}/src/checkpoints/pairing-vectors.json`, 'utf8'));
const s = vec.scalars;
...
const single = JSON.parse(readFileSync(`${VERIFIER}/src/bch/groth16-singleton-vectors.json`, 'utf8'));
...
const outPath = `${VERIFIER}/src/bch/groth16-singleton-multiproof-vectors.json`;
