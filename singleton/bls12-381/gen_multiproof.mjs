...
//   verifier/src/bch/groth16-bls12381-singleton-multiproof-vectors.json
//
...
const NOBLE = pathToFileURL(`${VERIFIER}/node_modules/@noble/curves/bls12-381.js`).href;
const {
...
const single = JSON.parse(readFileSync(`${VERIFIER}/src/bch/groth16-bls12381-singleton-vectors.json`, 'utf8'));
...
const outPath = `${VERIFIER}/src/bch/groth16-bls12381-singleton-multiproof-vectors.json`;
