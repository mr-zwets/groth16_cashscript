...
const specConfig = (specs, i, nextLockingBytecode) => {
  ...
  if (forward !== null && nextLockingBytecode !== undefined) {
    ...
    // direct equality tunes one byte smaller for inputs 2..6 as a group; SHA-256
    // is smaller on the remaining edges.
    forward = MILLER_TORUS && i >= 2 && i <= 6
